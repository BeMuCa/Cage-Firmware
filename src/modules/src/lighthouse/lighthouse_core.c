...
pulseProcessor_t lighthouseCoreState = {
  .bsGeometry = {
    // BCS Lab LH1
    {.valid = true, .origin = {-1.39975749,-2.51708666, 2.68519639, }, .mat = {{0.43674409,-0.85448295, 0.2812712, }, {0.78744366,0.51430923,0.33973299, }, {-0.43495642, 0.07310884, 0.8974787, }, }},
    {.valid = true, .origin = {1.77511406,2.37504284,2.67331141, }, .mat = {{-0.47991411, 0.86012059,-0.1728439, }, {-0.7807291 ,-0.50857502,-0.36306133, }, {-0.40018062,-0.03929399, 0.9155935, }, }},
    // Arena LH2
